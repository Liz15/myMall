<?php
    use yii\bootstrap\ActiveForm;//帮助创建form组件
    use yii\helpers\Html;
?>
<!DOCTYPE html>
<html class="login-bg">
<head>
    <title>文文数码商城 - 后台管理</title>
...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 box">
        <div class="content-wrap">
            <h6>文文数码商城 - 后台管理</h6>
            <?php echo $form->field($model,'adminname')->textInput(["class"=>"span12","placeholder"=>"管理员帐号"])?>
            <?php echo $form->field($model,'adminpass')->passwordInput(["class"=>"span12","placeholder"=>"管理员密码"])?>
            <a href="<?php echo yii\helpers\Url::to(['public/findpass'])?>" class="forgot">忘记密码?</a>
            <?php echo $form->field($model,'remember_me')->checkbox(['id'=>'remember_me','template'=>'<div class="remember">{input}<label for="remember-me">记住我</label></div>'])?>
