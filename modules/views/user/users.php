                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            <td>
                                  <!-- 判断有无头像-->
                                <?php if (empty($user->userinfo->avatar)): ?>
                                    <img src="<?php echo Yii::$app->params['defaultValue']['avatar']; ?>" class="img-circle avatar hidden-phone" />
                                <?php else: ?>
                                    <img src="assets/uploads/avatar/<?php echo $user->userinfo->avatar; ?>" class="img-circle avatar hidden-phone" />
                                <?php endif; ?>
                                <a href="#" class="name"><?php echo $user->username; ?></a>
                                <span class="subtext"><?php echo $user->useremail; ?></span>
                            </td>
                            <td>
                                <?php echo isset($user->userinfo->realname) ? $user->userinfo->realname : '未填写'; ?>
                            </td>
                            <td>
                                <?php echo isset($user->userinfo->nickname) ? $user->userinfo->nickname : '未填写'; ?>
                            </td>
                            <td>
                                <?php echo isset($user->userinfo->sex) ? $user->userinfo->sex : '未填写'; ?>
                            </td>
                            <td>
                                <?php echo isset($user->userinfo->age) ? $user->userinfo->age : '未填写'; ?>
                            </td>
                            <td>
                                <?php echo isset($user->userinfo->birthday) ? $user->userinfo->birthday : '未填写'; ?>
                            </td>
