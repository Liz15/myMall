...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        ...
        <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">文文数码商城 - 后台管理</a>
    ...
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="<?php echo yii\helpers\Url::to(['manage/addadmin'])?>">加入新管理员</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
